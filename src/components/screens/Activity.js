  ...
  return (
    <View style={{ width: '100%', height: '100%', backgroundColor: 'white' }}>
      ...
      <ScrollView style={{ margin: 10 }} showsVerticalScrollIndicator={false}>
        <Text style={{ fontWeight: 'bold', color: '#000000' }}>This Week</Text>
        <View style={{ flexDirection: 'row', paddingVertical: 10 }}>
          ...
          <Text style={{ color: '#000000' }}> Started following you</Text>
        </View>
        <Text style={{ fontWeight: 'bold', color: '#000000' }}>Earlier</Text>
              ...
              <View
                ...
                <TouchableOpacity
                  ...
                  <Text style={{ fontSize: 15, color: '#000000' }}>
                    <Text style={{ fontWeight: 'bold', color: '#000000' }}>{data.name}</Text>, who
        ...
        <Text style={{ fontWeight: 'bold', color: '#000000', paddingVertical: 10 }}>
          Suggestions for you
        </Text>
                  ...
                  <View>
                    <TouchableOpacity
                      ...
                      <View style={{ width: '100%' }}>
                        ...
                        <Text style={{ fontSize: 12, color: '#000000', opacity: 0.5 }}>
                          {data.accountName}
                        </Text>
                        <Text style={{ fontSize: 12, color: '#000000', opacity: 0.5 }}>
                          Sugggested for you
